...
Science is a way of thinking, observing and doing things to understand the world we live in and to uncover the secrets of the universe. Think of it as a big adventure where we ask questions, explore the world and try to understand how things work. For this, the most important thing is to have 'Curiosity', which is where the title of this book comes from.
...
The most wonderful thing about science is that it is everywhere. From the depths of the ocean to the vastness of outer space, from what is cooking in the kitchen to what is happening on the playground, some of the most groundbreaking discoveries have often come from unexpected places.
...
You would then test this guess by opening the pen and checking the ink refill. If it is empty, you would know that your guess was correct. But suppose you found that the ink was not finished. Now what would you do? You would make another guess: perhaps the ink might have dried up. To test if this guess is correct or not, you will try something else.
...
### The Scientific Method: Steps to Follow
...
### Scientists Are Everyone Who Follows the Scientific Method
...
Much like children enjoying the rain, science is all about joyful exploration. Enjoy your scientific journey, keep exploring and never stop wondering about the amazing mysteries of the universe and asking questions. After all, to be a wise person, you must be a "whys" person!
...
- Understand what science is and its importance in daily life
- Recognize the scientific method as a systematic approach to problem solving
- Identify examples of scientific thinking in everyday situations
- Appreciate the collaborative nature of scientific work
- Develop curiosity and observe phenomena around them

---

## KEY VOCABULARY

- Science: A way of thinking, observing and doing things to understand the world
- Curiosity: The desire to know or learn something
- Scientific Method: A systematic process of observation, questioning, guessing, testing, and analyzing
- Observation: Noticing something carefully
- Hypothesis: A guess or possible answer to a question
- Experiment: A test to check if a guess is correct
- Analysis: Studying the results carefully to understand them
